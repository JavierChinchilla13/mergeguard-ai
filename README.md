...
[![Gemini 1.5 Flash](https://img.shields.io/badge/AI-Gemini%201.5%20Flash-blue?logo=google-gemini)](https://deepmind.google/technologies/gemini/)
...
*   **AI Engine:** Gemini 1.5 Flash (chosen for low-latency and high context-window efficiency).
...
### Gemini Logic
*   **Model:** `gemini-1.5-flash` for its 1M+ token context and rapid inference.
...
*Initial PR input and system status dashboard.*

![Analysis Results](./public/screenshots/analysis-results.png)
*Structured findings categorized by severity and technical impact.*

![Observability Panel](./public/screenshots/observability-panel.png)
*Latency metrics and pipeline execution logs.*

![GitHub Preview](./public/screenshots/github-preview.png)
*Markdown report preview before posting to GitHub.*
